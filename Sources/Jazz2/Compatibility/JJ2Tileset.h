...
namespace Jazz2::Compatibility
{
	...
	*/
	...
	{
	public:
		using ImageSink = bool (*)(void* context, const std::uint32_t* palette,
		 ...
		 *
		 * If @p includeImage is false, the output contains only runtime metadata and is marked as a PSP
		 * sidecar. @p imageSink can consume the already assembled diffuse pixels without rereading QOI.
		 */
		bool Convert(StringView targetPath, bool includeImage = true,
			ImageSink imageSink = nullptr, void* imageSinkContext = nullptr) const;
