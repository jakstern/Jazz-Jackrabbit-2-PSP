...
namespace Jazz2::Actors::Multiplayer
{
	...
	void RemotablePlayer::SpawnCorpse()
	{
		// Already created and broadcasted by the server. Spawning one locally would leave a second, unreplicated
		// corpse that the server can never retire when this player dies again.
	}
