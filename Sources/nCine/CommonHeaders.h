...
// PSP has no GL 3.x; use the fake-GL shim so nCine's GL wrapper classes compile. Real drawing
// happens through the PSP GU backend, not these wrappers (their GL bodies are stubbed).
#		include "Graphics/GL/GLShim.h"
