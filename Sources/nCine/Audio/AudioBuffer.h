...
namespace nCine
{
	...
	*/
	...
	public:
		...
		/** @brief Returns decoded interleaved PCM samples on native backends */
	...
	private:
		...
		float duration_;
		/** @brief Decoded PCM owned by the PSP software mixer */
		std::unique_ptr<unsigned char[]> samples_;
